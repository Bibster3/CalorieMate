  ...
  return (
    <>
      ...
      <div className="flex overflow-x-hidden snap-x snap-mandatory h-screen">
        <section
          ref={refs.hero}
          className="snap-start flex-shrink-0 w-screen min-h-screen relative overflow-y-hidden"
        >
        ...
        <section
          ref={refs.info}
          className="snap-start flex-shrink-0 w-screen min-h-screen relative overflow-y-auto"
        >
          <PersonalInfoForm />
